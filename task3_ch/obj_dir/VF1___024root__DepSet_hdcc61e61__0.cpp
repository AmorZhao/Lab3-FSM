...
VL_INLINE_OPT void VF1___024root___sequent__TOP__0(VF1___024root* vlSelf) {
    ...
    // Init
    SData/*15:0*/ __Vdly__F1__DOT__BPS_modified__DOT__count;
    // Body
    __Vdly__F1__DOT__BPS_modified__DOT__count = vlSelf->F1__DOT__BPS_modified__DOT__count;
    if (vlSelf->rst) {
        vlSelf->F1__DOT__Light__DOT__current_state = 0U;
        vlSelf->F1__DOT__tick = 0U;
        __Vdly__F1__DOT__BPS_modified__DOT__count = vlSelf->N;
    } else {
        if (vlSelf->F1__DOT__tick) {
            vlSelf->F1__DOT__Light__DOT__current_state 
                = vlSelf->F1__DOT__Light__DOT__next_state;
        }
        if (vlSelf->en) {
            if ((0U == (IData)(vlSelf->F1__DOT__BPS_modified__DOT__count))) {
                vlSelf->F1__DOT__tick = 1U;
                __Vdly__F1__DOT__BPS_modified__DOT__count 
                    = vlSelf->N;
            } else {
                __Vdly__F1__DOT__BPS_modified__DOT__count 
                    = (0xffffU & ((IData)(vlSelf->F1__DOT__BPS_modified__DOT__count) 
                                  - (IData)(1U)));
                vlSelf->F1__DOT__tick = 0U;
            }
        }
    ...
    vlSelf->F1__DOT__BPS_modified__DOT__count = __Vdly__F1__DOT__BPS_modified__DOT__count;
}
